...
async function getCategoriesData(locale: string, slug: string[]) {
  'use cache'
  cacheLife('minutes')
  ...
  return [categories, subcategories, allProducts] as const;
}
...
export default async function ProductsPage({ params }: ProductsPageProps) {
  ...
  const [categories, subcategories, allProducts] = await getCategoriesData(locale, slug)
