     ...
     <div className="flex items-center justify-between">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 w-full">
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center shadow-md space-x-3 space-y-0 rounded-md p-4">
                    <FormControl>
                      <Checkbox
                        checked={field.value}
                        className="data-[state=checked]:bg-red-500 focus:ring-red-500"
                    ...
                    <div className="space-y-1 leading-none">
                      ...
                      <FormDescription>
                        Apabila iya, Produk ini akan keluar di landing page.
                      </FormDescription>
                    </div>
                  </FormItem>
                )}
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center shadow-md space-x-3 space-y-0 rounded-md p-4">
                    ...
                    <div className="space-y-1 leading-none">
                      ...
                      <FormDescription>
                        Apabila iya, Produk ini tidak akan muncul di website.
                      </FormDescription>
                    </div>
                  </FormItem>
                )}
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center shadow-md space-x-3 space-y-0 rounded-md p-4">
                    ...
                    <div className="space-y-1 leading-none">
                      ...
                      <FormDescription>
                        Apabila iya, Produk ini akan muncul dibagian featured.
                      </FormDescription>
                    </div>
                  </FormItem>
                )}
          ...
          <Button disabled={loading} className="ml-auto bg-green-500 text-white hover:bg-green-600 transition-colors" type="submit" variant={'default'}>
            {action}
          </Button>
        </form>
      </Form>
