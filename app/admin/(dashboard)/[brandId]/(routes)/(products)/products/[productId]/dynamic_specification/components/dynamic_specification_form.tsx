      ...
      const fetchData = async () => {
        ...
        initialData.forEach((val: specificationconnector) => {
          ...
          const existingGroup = tempFinal.find(
            (group) => group.dynamicspecificationParentId === parentId 
            // && group.dynamicspecificationSubParentId === subParentId
          )
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const payloads = groups.flatMap((g) =>
      g.specs.map((r) => ({
        ...
        dynamicspecificationSubParentId: r.dynamicspecificationSubParentId && r.dynamicspecificationSubParentId != '-' && r.dynamicspecificationSubParentId != '' ? r.dynamicspecificationSubParentId : null, // optional single sub-parent per group
