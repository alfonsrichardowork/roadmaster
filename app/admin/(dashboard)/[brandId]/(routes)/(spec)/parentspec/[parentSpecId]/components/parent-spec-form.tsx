              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input disabled={loading} placeholder="Parent Specification name" className="border-foreground" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input disabled={loading} placeholder="Parent Specification name (English)" className="border-foreground" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
