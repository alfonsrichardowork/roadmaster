        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            {/* <p className="text-primary-foreground/80 text-sm leading-relaxed">
              Premium audio equipment engineered for exceptional sound quality. Experience music like never before.
            </p> */}
            {/* <div className="flex gap-6 mt-6">
              <Link
                href="https://www.instagram.com/roadmasterspeaker"
                target="blank"
                className="text-background hover:text-accent transition-colors duration-300"
              >
                <svg
                  className="w-6 h-6"
                  width="32"
